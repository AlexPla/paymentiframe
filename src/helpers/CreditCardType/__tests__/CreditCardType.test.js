...
describe('Credit card type:', () => {
  ...
  it('Expect ELO card to be correct', () => {
    ...
    const eloCardExpected = {
      ...
      lengths: [16],
      niceType: 'Elo',
      pattern: '^((509091)|(636368)|(636297)|(504175)|(438935)|(40117[8-9])|(451416)|(45763[1-2])|(457393)|(431274)|(50990[0-2])|(5099[7-9][0-9])|(50996[4-9])|(509[1-8][0-9][0-9])|(5090(0[0-2]|0[4-9]|1[2-9]|[24589][0-9]|3[1-9]|6[0-46-9]|7[0-24-9]))|(506699)|(5067(0[0-24-8]|1[0-24-9]|2[014-9]|3[0-379]|4[0-9]|5[0-3]|6[0-5]|7[0-8]))|(627780)|(65003[1-3])|(6500(3[5-9]|4[0-9]|5[0-1]))|(6504(0[5-9]|1[0-9]|2[0-9]|3[0-9]))|(6504(8[5-9]|9[0-9])|6505(0[0-9]|1[0-9]|2[0-9]|3[0-8]))|(6505(4[1-9]|5[0-9]|6[0-9]|7[0-9]|8[0-9]|9[0-8]))|(6507(0[0-9]|1[0-8]))|(65072[0-7])|(6509(0[1-9]|1[0-9]|20))|(6516(5[2-9]|6[0-9]|7[0-9]))|(6550(0[0-9]|1[0-9]))|(6550(2[1-9]|3[0-9]|4[0-9]|5[0-8])))\\d*$',
      type: constants.ELO,
    };
  ...
  it('should return ELO card type when two possible cardTypes are found', () => {
    const masterCardType = {
      niceType: 'MasterCard',
      type: constants.MASTERCARD,
      pattern: /^5(?!(06699)|(0670[7-8])|(06715)|(0671[7-9])|(0672[0-1])|(0672[4-9])|(0673[0-3])|(06739)|(0674[0-8])|(0675[0-3])|(0677[4-8])|(0900[0-9])|(0901[3-9])|(0902[0-9])|(0903[1-5])|(0903[8-9])|(0904[0-9])|(0905[0-9])|(0906[0-4])|(0906[6-9])|(0907[0-2])|(0907[4-5])|(04175)|(0907[6-9])|(0908[0-9])|(30032)|(22499)|(09[0-7][0-9]{2})|(09[8]0[0-9])|509810)\d*$/,
    ...
    const cards = [masterCardType, eloType];
    expect(CreditCardType.getCardTypeFromCards(cards)).toEqual(eloType);
  });
