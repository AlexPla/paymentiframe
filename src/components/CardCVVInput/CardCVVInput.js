  ...
  render() {
    ...
    return (
      <div className={`card-cvv-input__input-group card-cvv-input__input-group__${parentApp}`}>
        ...
        <input
          className={`card-cvv-input__input card-cvv-input__input__${parentApp} ${!isEmpty && 'card-cvv-input__input__not-empty'} ${!errorDisabled && errorMessage && 'card-cvv-input__input_invalid'}`}
          type="password"
          autoComplete="off"
          name="cardCVVInput"
          value={value}
