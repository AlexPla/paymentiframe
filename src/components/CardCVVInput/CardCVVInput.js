...
class CardCVVInput extends Component {
  ...
  renderIcon = (errorDisabled, errorMessage) => (
    <svg className={`card-cvv-input__icon ${!errorDisabled && errorMessage && 'card-cvv-input__icon_invalid'}`} focusable="false" version="1.1" xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" viewBox="0 0 150 150" preserveAspectRatio="xMidYMid meet">
