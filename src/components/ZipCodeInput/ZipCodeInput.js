  ...
  render() {
    ...
    return (
      <div className={`zip-code__input-group zip-code__input-group__${parentApp}`}>
        ...
        { !isEmpty
          && (
          <svg className={`zip-code__clear-button zip-code__clear-button__${parentApp}`} onClick={this.onClearClick} version="1.1" xmlns="http://www.w3.org/2000/svg" width="15px" height="15px" viewBox="0 0 150 150" preserveAspectRatio="xMidYMid meet">
