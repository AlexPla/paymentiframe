...
class CardHolderInput extends Component {
  ...
  renderIcon = (errorDisabled, errorMessage) => (
    <svg className={`card-holder-input__icon ${!errorDisabled && errorMessage && 'card-holder-input__icon_invalid'}`} version="1.1" xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" viewBox="0 0 150 150" preserveAspectRatio="xMidYMid meet">
  ...
  renderClearButton = parentApp => (
    <svg className={`card-holder-input__clear-button card-holder-input__clear-button__${parentApp}`} onMouseDown={this.onClearClick} version="1.1" xmlns="http://www.w3.org/2000/svg" width="15px" height="15px" viewBox="0 0 150 150" preserveAspectRatio="xMidYMid meet">
