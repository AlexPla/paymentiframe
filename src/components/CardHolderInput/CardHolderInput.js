  ...
  render() {
    ...
    return (
      <div className="card-holder-input__input-group">
        ...
        { !isEmpty
          && (
          <svg className={`card-holder-input__clear-button card-holder-input__clear-button__${parentApp}`} onClick={this.onClearClick} version="1.1" xmlns="http://www.w3.org/2000/svg" width="15px" height="15px" viewBox="0 0 150 150" preserveAspectRatio="xMidYMid meet">
