...
class CardNumberInput extends Component {
  ...
  renderIcon = (errorDisabled, errorMessage) => (
    <svg className={`card-number__icon ${!errorDisabled && errorMessage && 'card-number__icon_invalid'}`} focusable="false" version="1.1" xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" viewBox="0 0 150 150" preserveAspectRatio="xMidYMid meet">
  ...
  renderClearButton = parentApp => (
    <svg className={`card-number__clear-button card-number__clear-button__${parentApp}`} focusable="false" onMouseDown={this.onClearClick} version="1.1" xmlns="http://www.w3.org/2000/svg" width="15px" height="15px" viewBox="0 0 150 150" preserveAspectRatio="xMidYMid meet">
