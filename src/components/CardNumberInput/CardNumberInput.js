  ...
  render() {
    ...
    return (
      <div className={`card-number__input-group card-number__input-group__${parentApp}`}>
        ...
        <input
          className={`card-number__input card-number__input__${parentApp} ${!isEmpty && 'card-number__input__not-empty'} ${!errorDisabled && errorMessage && 'card-number__input_invalid'}`}
          type="text"
          inputMode="numeric"
          pattern="[0-9]*"
          autoComplete="off"
        ...
        { !isEmpty
          && (
          <svg className={`card-number__clear-button card-number__clear-button__${parentApp}`} onClick={this.onClearClick} version="1.1" xmlns="http://www.w3.org/2000/svg" width="15px" height="15px" viewBox="0 0 150 150" preserveAspectRatio="xMidYMid meet">
