...
class CardExpDateInput extends Component {
  ...
  renderIcon = (errorDisabled, errorMessage) => (
    <svg className={`card-exp-date__icon ${!errorDisabled && errorMessage && 'card-exp-date__icon_invalid'}`} focusable="false" width="20px" height="20px" viewBox="0 0 150 150" preserveAspectRatio="xMidYMid meet" version="1.1" xmlns="http://www.w3.org/2000/svg">
  ...
  renderClearButton = parentApp => (
    <svg className={`card-exp-date__clear-button card-exp-date__clear-button__${parentApp}`} focusable="false" onMouseDown={this.onClearClick} version="1.1" xmlns="http://www.w3.org/2000/svg" width="15px" height="15px" viewBox="0 0 150 150" preserveAspectRatio="xMidYMid meet">
